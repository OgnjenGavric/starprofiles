...
const toggleItem = (item) => {
  ...
  if (item.classList.contains('accordion-open')) {
    accordionContent.removeAttibute('style');
...
sr.reveal(`.home__value`, { delay: 200, origin: 'bottom' });
...
// const contactMassage = document.getElementById("contact-message");
// const sendEmail = (e) => {
//   e.preventDefault();
//   // serviceID - templateID - #form - publicKey
//   /*  emailjs.sendForm("service_7qxabrt", "template_p5utbxj", "#contact-form", "c3XQf4zucRyUuCyM-")
//      .then(() => {
//        // Show sent message
